...
# Load data
data = load_csv('/Users/jelenajaksic/Desktop/psz-projekat/prediction-models/bgd1010.csv')
...
data_train, data_test = train_test_split(data, 0.05)
